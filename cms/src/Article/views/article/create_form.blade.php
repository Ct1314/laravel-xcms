    ...
    <div role="tabpanel" class="tab-pane active" id="base">
        <div style="margin-top: 30px;">
            ...
            <div class="form-group">
                ...
                <div class="col-md-8">
                    <input type="text" name="tag" id="tag" class="form-control"  placeholder="输入后按下回车确认">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label for="abstract" class="control-label col-md-2">内容摘要</label>
                <div class="col-md-8">
    ...
    <div role="tabpanel" class="tab-pane" id="advance">
        <div style="margin-top: 30px;">
            <div class="form-group">
                ...
                <div class="col-md-8">
                    <label class="radio-inline" for="is_comment_1">
                        <input type="radio" name="is_comment" value="1" id="is_comment_1" checked> 允许评论
                    </label>
            ...
            <div class="form-group">
                ...
                <div class="col-md-8">
                    <input type="text" id="browse_count" class="form-control" name="browse_count" value="0">
                </div>
            </div>
            <div class="form-group">
                <!-- author Form Input  -->
